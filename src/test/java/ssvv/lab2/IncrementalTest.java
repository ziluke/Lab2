...
public class IncrementalTest {
    ...
    @Test
    public void tc_2_addStudent_addAssignment(){
        int aux = service.saveStudent("33", "New Student 3", 934);
        assertEquals(1, aux);

        aux = service.saveTema("1", "Desc", 10, 8);
        assertEquals(1, aux);
    }

    @Test
    public void tc_3_addStudent_addAssignment_addGrade(){
        int aux = service.saveStudent("33", "New Student 3", 934);
        assertEquals(1, aux);
        ...
        aux = service.saveNota("33", "1", 9, 9, "Nice work");
        assertEquals(1, aux);
    }
